---
title: Why Cannae did not end the war
summary: >
...
stops:
  - type: event
    ...
    note: >
      The engagement itself. Hannibal's tactical masterpiece; the
      Roman field army the senate had assembled at unprecedented
      scale destroyed.
  - type: editorial-take
  ...
  - type: event
    ...
    note: >
      The post-Cannae allied defection that the strategy had
      assumed would be enough. Capua and substantial Italian Greek
      cities shifted alignment; the core Latin League did not.
  - type: event
  ...
  - type: claim
    slug: tagus-tactical-template-for-italy
    note: >
      The continuity-of-method reading: Tagus prefigures Trebia,
...
feature that distinguishes this war from contemporary Mediterranean
conflicts.
...
long-standing march-on-Rome counterfactual). The thread is the
prose-walked version of that synthesis.

For readers who want the longer narrative integration, the
[Second Punic War period page](/periods/06-second-punic-war) provides
the full chronological framework into which these engagements fit.
