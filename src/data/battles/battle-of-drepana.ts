...
const config: BattleDiagramConfig = {
  ...
  phases: [
    {
      label: 'The dawn approach',
      title:
        'Pulcher’s column hugs the coast toward the harbor of Drepana at dawn while Adherbal’s fleet lies at anchor inside',
      description:
        'Pulcher’s 123 ships hug the coast toward Drepana at dawn, strung out in a long column, hoping to catch the Carthaginian fleet at anchor. Adherbal’s ships still lie inside the harbor as the lead Roman ships reach the mouth.',
      background: '#eaf4fb',
      northArrow: true,
      units: [
        ...
        { rect: { x: 304, y: 66, w: 14, h: 6, rx: 1.5 }, fill: '#5b0f31', stroke: '#1a0410' },
        { rect: { x: 326, y: 74, w: 14, h: 6, rx: 1.5 }, fill: '#5b0f31', stroke: '#1a0410' },
        { rect: { x: 306, y: 84, w: 14, h: 6, rx: 1.5 }, fill: '#5b0f31', stroke: '#1a0410' },
        { rect: { x: 328, y: 92, w: 14, h: 6, rx: 1.5 }, fill: '#5b0f31', stroke: '#1a0410' },
        { rect: { x: 308, y: 102, w: 14, h: 6, rx: 1.5 }, fill: '#5b0f31', stroke: '#1a0410' },
        // Roman column strung along the coast from the south
        { rect: { x: 236, y: 96, w: 7, h: 14, rx: 1.5 }, fill: '#1e3a8a', stroke: '#172554' },
        { rect: { x: 244, y: 124, w: 7, h: 14, rx: 1.5 }, fill: '#1e3a8a', stroke: '#172554' },
        { rect: { x: 250, y: 152, w: 7, h: 14, rx: 1.5 }, fill: '#1e3a8a', stroke: '#172554' },
        { rect: { x: 254, y: 180, w: 7, h: 14, rx: 1.5 }, fill: '#1e3a8a', stroke: '#172554' },
        { rect: { x: 258, y: 208, w: 7, h: 14, rx: 1.5 }, fill: '#1e3a8a', stroke: '#172554' },
        { rect: { x: 260, y: 236, w: 7, h: 14, rx: 1.5 }, fill: '#1e3a8a', stroke: '#172554' },
        { rect: { x: 262, y: 264, w: 7, h: 14, rx: 1.5 }, fill: '#1e3a8a', stroke: '#172554' },
        { rect: { x: 262, y: 292, w: 7, h: 14, rx: 1.5 }, fill: '#1e3a8a', stroke: '#172554' },
      ],
      arrows: [
        // Lead ships entering the harbor mouth
        { from: [240, 92], to: [262, 66], color: '#172554' },
      ],
      annotations: [
        ...
        { x: 180, y: 200, text: 'Pulcher’s column (123 ships)', size: 8, color: '#172554', weight: 600 },
        { x: 180, y: 214, text: 'hugging the coast at dawn', size: 8, color: '#172554', italic: true },
        { x: 80, y: 300, text: 'open water', size: 8, color: '#0369a1', italic: true },
      ],
    },
    {
      label: 'Adherbal slips out and rounds the line',
      title:
      ...
      description:
        'Rather than be trapped at anchor, Adherbal leads his fleet out along the seaward side of the channel while the Roman column is still feeding into the harbor mouth, then rounds the Roman line and forms up in open water. The recalled Roman ships bunch into a ragged line with the shore directly astern.',
      background: '#eaf4fb',
      units: [
        // Mainland
        {
        ...
        { rect: { x: 116, y: 96, w: 14, h: 6, rx: 1.5 }, fill: '#5b0f31', stroke: '#1a0410' },
        { rect: { x: 112, y: 122, w: 14, h: 6, rx: 1.5 }, fill: '#5b0f31', stroke: '#1a0410' },
        { rect: { x: 108, y: 148, w: 14, h: 6, rx: 1.5 }, fill: '#5b0f31', stroke: '#1a0410' },
        { rect: { x: 106, y: 174, w: 14, h: 6, rx: 1.5 }, fill: '#5b0f31', stroke: '#1a0410' },
        { rect: { x: 104, y: 200, w: 14, h: 6, rx: 1.5 }, fill: '#5b0f31', stroke: '#1a0410' },
        // Roman ships recalled, bunching into a ragged inshore line
        { rect: { x: 226, y: 104, w: 7, h: 14, rx: 1.5 }, fill: '#1e3a8a', stroke: '#172554' },
        { rect: { x: 234, y: 132, w: 7, h: 14, rx: 1.5 }, fill: '#1e3a8a', stroke: '#172554' },
        { rect: { x: 228, y: 160, w: 7, h: 14, rx: 1.5 }, fill: '#1e3a8a', stroke: '#172554' },
        { rect: { x: 236, y: 188, w: 7, h: 14, rx: 1.5 }, fill: '#1e3a8a', stroke: '#172554' },
        { rect: { x: 230, y: 216, w: 7, h: 14, rx: 1.5 }, fill: '#1e3a8a', stroke: '#172554' },
        { rect: { x: 238, y: 244, w: 7, h: 14, rx: 1.5 }, fill: '#1e3a8a', stroke: '#172554' },
      ],
      arrows: [
        // Adherbal's exit: out the mouth, around, and down the seaward side
        { from: [280, 58], to: [196, 56], via: [238, 70], color: '#1a0410' },
        { from: [186, 60], to: [128, 92], via: [142, 58], color: '#1a0410' },
        // Roman recall: lead ships backing out of the mouth
        { from: [254, 70], to: [234, 100], color: '#172554', dasharray: '4,3' },
      ],
      annotations: [
        ...
        { x: 296, y: 170, text: 'Romans recalled,', size: 8, color: '#172554', anchor: 'start' },
        { x: 296, y: 182, text: 'shore astern', size: 8, color: '#172554', italic: true, anchor: 'start' },
        { x: 200, y: 300, text: 'the trap has reversed before a ram touches a hull', size: 8, color: '#57534e', italic: true },
      ],
    },
    {
      label: 'Pinned against the shore',
      title:
      ...
      description:
        'With open water astern, Adherbal’s captains can charge, back water, and charge again; the Roman ships, pinned against the coast, can do neither. Roughly 93 of the 123 Roman ships are lost, and Pulcher escapes south with about thirty.',
      background: '#eaf4fb',
      units: [
        // Mainland
        {
        ...
        { rect: { x: 152, y: 100, w: 14, h: 6, rx: 1.5 }, fill: '#5b0f31', stroke: '#1a0410' },
        { rect: { x: 148, y: 128, w: 14, h: 6, rx: 1.5 }, fill: '#5b0f31', stroke: '#1a0410' },
        { rect: { x: 146, y: 156, w: 14, h: 6, rx: 1.5 }, fill: '#5b0f31', stroke: '#1a0410' },
        { rect: { x: 144, y: 184, w: 14, h: 6, rx: 1.5 }, fill: '#5b0f31', stroke: '#1a0410' },
        { rect: { x: 142, y: 212, w: 14, h: 6, rx: 1.5 }, fill: '#5b0f31', stroke: '#1a0410' },
        // Roman line breaking up against the coast
        { rect: { x: 230, y: 108, w: 7, h: 14, rx: 1.5 }, fill: '#1e3a8a', stroke: '#172554', strokeDasharray: '3,2', opacity: 0.6 },
        { rect: { x: 238, y: 138, w: 7, h: 14, rx: 1.5 }, fill: '#1e3a8a', stroke: '#172554', strokeDasharray: '3,2', opacity: 0.6 },
        { rect: { x: 232, y: 168, w: 7, h: 14, rx: 1.5 }, fill: '#1e3a8a', stroke: '#172554', strokeDasharray: '3,2', opacity: 0.6 },
        { rect: { x: 240, y: 198, w: 7, h: 14, rx: 1.5 }, fill: '#1e3a8a', stroke: '#172554', strokeDasharray: '3,2', opacity: 0.6 },
        // Pulcher's surviving squadron escaping south
        { rect: { x: 218, y: 268, w: 7, h: 14, rx: 1.5 }, fill: '#1e3a8a', stroke: '#172554' },
      ],
      arrows: [
        ...
        // Pulcher's escape
        { from: [224, 264], to: [212, 308], color: '#172554', dasharray: '4,3' },
      ],
      annotations: [
        { x: 110, y: 90, text: 'charge, back water, charge again', size: 8, color: '#1a0410', italic: true },
        { x: 312, y: 154, text: 'no room', size: 8, color: '#172554', anchor: 'start' },
        { x: 312, y: 166, text: 'to back water', size: 8, color: '#172554', italic: true, anchor: 'start' },
        { x: 160, y: 296, text: 'Pulcher escapes with ~30 ships', size: 8, color: '#172554', italic: true },
        { x: 200, y: 24, text: '~93 of 123 Roman ships lost', size: 9, color: '#57534e', weight: 600 },
      ],
    },
  ],
  legend: [
    { label: 'Roman fleet (Pulcher)', fill: '#1e3a8a', stroke: '#172554' },
