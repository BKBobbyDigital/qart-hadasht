...
const config: BattleDiagramConfig = {
  ...
  phases: [
    {
      label: 'Hanno runs east before the wind',
      title:
      ...
      description:
        'Hanno’s relief fleet, laden with supplies for Hamilcar Barca’s army at Mount Eryx and rowed by inexperienced crews, runs east from Hiera before a strong westerly. The plan is to unload first, embark Hamilcar’s veterans as marines, and only then offer battle.',
      background: '#eaf4fb',
      northArrow: true,
      units: [
        ...
        { rect: { x: 62, y: 128, w: 15, h: 6, rx: 1.5 }, fill: '#5b0f31', stroke: '#1a0410' },
        { rect: { x: 84, y: 142, w: 15, h: 6, rx: 1.5 }, fill: '#5b0f31', stroke: '#1a0410' },
        { rect: { x: 64, y: 156, w: 15, h: 6, rx: 1.5 }, fill: '#5b0f31', stroke: '#1a0410' },
        { rect: { x: 86, y: 170, w: 15, h: 6, rx: 1.5 }, fill: '#5b0f31', stroke: '#1a0410' },
        { rect: { x: 66, y: 184, w: 15, h: 6, rx: 1.5 }, fill: '#5b0f31', stroke: '#1a0410' },
        // Roman fleet waiting off Aegusa
        { rect: { x: 222, y: 150, w: 7, h: 14, rx: 1.5 }, fill: '#1e3a8a', stroke: '#172554' },
        { rect: { x: 234, y: 172, w: 7, h: 14, rx: 1.5 }, fill: '#1e3a8a', stroke: '#172554' },
        { rect: { x: 226, y: 194, w: 7, h: 14, rx: 1.5 }, fill: '#1e3a8a', stroke: '#172554' },
      ],
      arrows: [
        // The westerly wind
      ...
      annotations: [
        ...
        { x: 262, y: 140, text: 'Lutatius (~200,', size: 8, color: '#172554', anchor: 'start' },
        { x: 262, y: 152, text: 'drilled all winter)', size: 8, color: '#172554', italic: true, anchor: 'start' },
    ...
    {
      label: 'Lutatius puts his line across the channel',
      title:
      ...
      description:
        'Lutatius, whose crews have drilled in these waters all winter, puts his line of battle across the Carthaginian course and accepts the fight in a rough sea rather than let the supplies through. The laden, undermanned Carthaginian ships have no room to refuse battle.',
      background: '#eaf4fb',
      units: [
        // Sicily
        {
        ...
        { rect: { x: 210, y: 84, w: 7, h: 14, rx: 1.5 }, fill: '#1e3a8a', stroke: '#172554' },
        { rect: { x: 212, y: 108, w: 7, h: 14, rx: 1.5 }, fill: '#1e3a8a', stroke: '#172554' },
        { rect: { x: 214, y: 132, w: 7, h: 14, rx: 1.5 }, fill: '#1e3a8a', stroke: '#172554' },
        { rect: { x: 214, y: 156, w: 7, h: 14, rx: 1.5 }, fill: '#1e3a8a', stroke: '#172554' },
        { rect: { x: 212, y: 180, w: 7, h: 14, rx: 1.5 }, fill: '#1e3a8a', stroke: '#172554' },
        // Carthaginian fleet committed, closing under sail
        { rect: { x: 122, y: 110, w: 15, h: 6, rx: 1.5 }, fill: '#5b0f31', stroke: '#1a0410' },
        { rect: { x: 140, y: 130, w: 15, h: 6, rx: 1.5 }, fill: '#5b0f31', stroke: '#1a0410' },
        { rect: { x: 124, y: 150, w: 15, h: 6, rx: 1.5 }, fill: '#5b0f31', stroke: '#1a0410' },
        { rect: { x: 142, y: 170, w: 15, h: 6, rx: 1.5 }, fill: '#5b0f31', stroke: '#1a0410' },
      ],
      arrows: [
        // Wind still driving east
        { from: [20, 60], to: [90, 60], color: '#0369a1', dasharray: '5,4', width: 2 },
        // Roman line closing from its station off Aegusa
        { from: [222, 196], to: [218, 150], color: '#172554' },
      ...
      annotations: [
        ...
        { x: 282, y: 120, text: 'the line blocks', size: 8, color: '#172554', anchor: 'start' },
        { x: 282, y: 132, text: 'the channel', size: 8, color: '#172554', italic: true, anchor: 'start' },
    ...
    },
    {
      ...
      description:
        'The light, well-drilled Roman ships outsail and outfight the laden hulls: about 50 Carthaginian ships are sunk and 70 captured. The survivors run back west to Hiera on the shifting wind, and Carthage, unable to build or man another fleet, authorizes Hamilcar to negotiate.',
      background: '#eaf4fb',
      units: [
        // Sicily
        {
        ...
        { path: 'M 178 218 Q 196 206 216 216 Q 224 230 208 240 Q 186 242 178 218 Z', fill: '#ecdcb0', stroke: '#a16207' },
        // Roman line holding
        { rect: { x: 206, y: 96, w: 7, h: 14, rx: 1.5 }, fill: '#1e3a8a', stroke: '#172554' },
        { rect: { x: 208, y: 122, w: 7, h: 14, rx: 1.5 }, fill: '#1e3a8a', stroke: '#172554' },
        { rect: { x: 210, y: 148, w: 7, h: 14, rx: 1.5 }, fill: '#1e3a8a', stroke: '#172554' },
        { rect: { x: 208, y: 174, w: 7, h: 14, rx: 1.5 }, fill: '#1e3a8a', stroke: '#172554' },
        // Carthaginian wrecks and prizes at the line
        { rect: { x: 168, y: 110, w: 15, h: 6, rx: 1.5 }, fill: '#5b0f31', stroke: '#1a0410', strokeDasharray: '3,2', opacity: 0.55 },
        { rect: { x: 172, y: 140, w: 15, h: 6, rx: 1.5 }, fill: '#5b0f31', stroke: '#1a0410', strokeDasharray: '3,2', opacity: 0.55 },
        { rect: { x: 170, y: 170, w: 15, h: 6, rx: 1.5 }, fill: '#5b0f31', stroke: '#1a0410', strokeDasharray: '3,2', opacity: 0.55 },
        // Survivors running west
        { rect: { x: 84, y: 130, w: 15, h: 6, rx: 1.5 }, fill: '#5b0f31', stroke: '#1a0410' },
        { rect: { x: 88, y: 156, w: 15, h: 6, rx: 1.5 }, fill: '#5b0f31', stroke: '#1a0410' },
      ],
      arrows: [
  ...
  legend: [
    { label: 'Roman fleet (Lutatius)', fill: '#1e3a8a', stroke: '#172554' },
