...
const config: BattleDiagramConfig = {
  ...
  phases: [
    {
      label: 'Phase 1 · The dispositions',
      title:
      ...
      units: [
        ...
        { rect: { x: 110, y: 112, w: 12, h: 5 }, fill: '#dc2626', stroke: '#7f1d1d' },
        { rect: { x: 140, y: 124, w: 12, h: 5 }, fill: '#dc2626', stroke: '#7f1d1d' },
        { rect: { x: 170, y: 136, w: 12, h: 5 }, fill: '#dc2626', stroke: '#7f1d1d' },
        { rect: { x: 110, y: 183, w: 12, h: 5 }, fill: '#dc2626', stroke: '#7f1d1d' },
        { rect: { x: 140, y: 171, w: 12, h: 5 }, fill: '#dc2626', stroke: '#7f1d1d' },
        { rect: { x: 170, y: 159, w: 12, h: 5 }, fill: '#dc2626', stroke: '#7f1d1d' },
        // Squadron III: the base of the wedge, towing the transports
        { rect: { x: 88, y: 104, w: 6, h: 92 }, fill: '#dc2626', stroke: '#7f1d1d' },
        // Transports inside the base
        { rect: { x: 62, y: 122, w: 16, h: 7 }, fill: '#f59e0b', stroke: '#92400e' },
        { rect: { x: 62, y: 146, w: 16, h: 7 }, fill: '#f59e0b', stroke: '#92400e' },
        { rect: { x: 62, y: 170, w: 16, h: 7 }, fill: '#f59e0b', stroke: '#92400e' },
        // Squadron IV (triarii) rearguard line astern
        {
          rect: { x: 34, y: 112, w: 6, h: 76 },
          fill: '#dc2626',
          stroke: '#7f1d1d',
          strokeDasharray: '3,2',
        },
        // Carthaginian center: thin extended line ahead of the wedge
        { rect: { x: 288, y: 108, w: 9, h: 84 }, fill: '#5b0f31', stroke: '#1a0410' },
      ...
      annotations: [
        ...
        { x: 135, y: 152, text: 'Squadrons I-II', size: 8, color: '#7f1d1d', weight: 600 },
        { x: 66, y: 189, text: 'transports', size: 7, color: '#92400e', italic: true },
        { x: 37, y: 102, text: 'Squadron IV (triarii)', size: 7, color: '#7f1d1d', anchor: 'start' },
    ...
    {
      label: 'Phase 2 · The center gives way; three battles open',
      title:
      ...
      units: [
        ...
        { rect: { x: 344, y: 112, w: 9, h: 76 }, fill: '#5b0f31', stroke: '#1a0410' },
      ...
      arrows: [
        ...
        // Roman apex pursuing
        { from: [225, 150], to: [288, 150], color: '#7f1d1d' },
        // Inshore wing onto transports
        { from: [190, 72], to: [104, 118], color: '#1a0410' },
        // Seaward wing onto triarii
        { from: [212, 258], to: [62, 200], color: '#1a0410' },
      ],
      annotations: [
        { x: 392, y: 102, text: 'center falls back as planned', size: 8, color: '#1a0410', italic: true, anchor: 'end' },
        { x: 246, y: 132, text: 'apex drawn forward', size: 8, color: '#7f1d1d', italic: true },
    ...
    {
      label: 'Phase 3 · Defeat in detail',
      title:
      ...
      arrows: [
        ...
        // Squadrons returning to the two wing fights
        { from: [200, 132], to: [130, 100], color: '#7f1d1d' },
        { from: [200, 168], to: [110, 226], color: '#7f1d1d' },
      ],
      annotations: [
        { x: 330, y: 104, text: 'center driven off', size: 8, color: '#1a0410', italic: true },
        { x: 226, y: 110, text: 'squadrons I-II return', size: 8, color: '#7f1d1d', italic: true },
  ...
  legend: [
    { label: 'Roman squadrons', fill: '#dc2626', stroke: '#7f1d1d' },
