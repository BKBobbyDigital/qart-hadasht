...
const config: FamilyTreeConfig = {
  ...
  caption:
    "Three generations of the Massylii royal house, with the Carthaginian Hasdrubal Gisco and the rival Masaesylii king Syphax shown for the dynastic connections that bind the tree to the broader Second Punic War African theater. Masinissa's marriage to Sophonisba in 203 BCE was the brief sequel to her earlier marriage to Syphax; she took poison rather than be surrendered to Roman custody, and produced no children with either husband. Masinissa's three sons by other unions — Micipsa, Gulussa, and Mastanabal — jointly inherited the unified Numidian kingdom on his death in 148 BCE, with Scipio Aemilianus dividing administrative responsibilities among them. Micipsa's nephew Jugurtha would later contest the inheritance in the war that bears his name (112–105 BCE), but that arc falls outside the Punic-period scope this tree covers. The tree also simplifies the succession: Livy says the kingship passed from Gala not to his son but, by Numidian seniority, to Gala's brother Oezalces and then to Oezalces's son Capussa, whom the usurper Mazaetullus killed before Masinissa took the kingdom back by war (29.29–30). Oezalces had married a niece of Hannibal, and Mazaetullus married her after him; that branch is not drawn here.",
};
