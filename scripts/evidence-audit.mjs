...
const REGRESSIONS = [
  ...
  {
    id: 'carthage-seventeen-days-unattributed',
    re: /(?<![Oo]rosius[^.]{0,200})seventeen[- ]days?(?![^.]{0,200}Orosius)/,
    right: 'The seventeen days of burning are Orosius 4.23.5 (fifth century CE), not Appian or Polybius. Attribute it.',
    fixed: 'Carthage after 146, Miles pp. 338-347',
  },
  {
    id: 'carthage-plowed-unattributed',
    re: /(?<!(Modestinus|Digest)[^.]{0,200})\bplow(ed|ing)?\b[^.]{0,40}(over|site|ruins|city)(?![^.]{0,200}(Modestinus|Digest|third-century))/i,
    right: 'The plow over Carthage is only in Modestinus, Digest 7.4.21 (third century CE). Attribute it.',
    fixed: 'Carthage after 146, Miles pp. 338-347',
  },
  {
    id: 'carthage-harbor-silted',
    re: /harbou?r[^.]{0,30}deliberately silted/i,
    right: 'No source says Rome silted Carthage\'s harbor.',
    fixed: 'Carthage after 146, Miles pp. 338-347',
  },
  {
    id: 'agri-romani-boundary',
    re: /agri Romani/,
    right: 'No such boundary. Appian 135: the site was to be obliterated, no one to live there, curses on rebuilding the Byrsa or Megara.',
    fixed: 'Carthage after 146, Miles pp. 338-347',
  },
  {
    id: 'carthage-hair-bowstrings',
    re: /hair[^.]{0,40}bowstrings?/i,
    right: 'Appian 93: the women\'s hair was cut for catapult cords.',
    fixed: 'Carthage after 146, Miles pp. 338-347',
  },
  {
    id: 'carthage-arms-20000',
    re: /(armou?r|panoplies)( and weapons)? for 20,000/i,
    right: 'Appian 80 (and Strabo 17.3.15): armor for 200,000 men. Miles has 20,000.',
    fixed: 'Carthage after 146, Miles pp. 338-347',
  },
  {
    id: 'piso-consul-147',
    re: /Piso[^.]{0,40}(consul )?(of|in|for) 147|147[^.]{0,20}(new )?(Roman )?consul[^.]{0,30}Piso/,
    right: 'Calpurnius Piso was consul in 148 (Appian 110). Miles has 147.',
    fixed: 'Carthage after 146, Miles pp. 338-347',
  },
  {
    id: 'tears-unbroken-chain',
    re: /chain is unbroken|most direct chain|most directly attested (moment|major event)/i,
    right: 'The tears survive in one Polybian fragment (38.21) plus Appian 132 and Diodorus 32.24, who report them; most of Polybius\'s account is lost.',
    fixed: 'Carthage after 146, Miles pp. 338-347',
  },
  {
    id: 'hasdrubal-recalled-147',
    re: /recalled[^.]{0,40}147/,
    right: 'Carthage reinstated Hasdrubal in 149 (Appian 93); he took command inside the city after 148 (111).',
    fixed: 'Carthage after 146, Miles pp. 338-347',
  },
  {
    id: 'tpw-150-lutatius-clause',
    re: /\b150\b[^.]{0,120}Lutatius|Lutatius[^.]{0,120}\b150\b/,
    right: 'The breach of 150 was of the treaty of 201 (no war in Africa without Roman consent), not a Lutatius clause.',
    fixed: 'Carthage after 146, Miles pp. 338-347',
  },
  {
